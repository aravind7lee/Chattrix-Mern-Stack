...
import toast from "react-hot-toast"; // make sure react-hot-toast is installed in your project
...
const ChatContainer = () => {
  ...
  // Handle sending a message (used by form onSubmit)
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      {/* bottom area - wrapped in a form to handle Enter properly */}
      <form
